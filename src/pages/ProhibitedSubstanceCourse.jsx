...
const courseContent = [
  { id: 1, title: "Introduction to Prohibited Substances", type: "video", duration: "10 min" },
  { id: 2, title: "Categories of Prohibited Substances", type: "reading", duration: "20 min" },
  { id: 3, title: "Anabolic Agents and their Effects", type: "video", duration: "15 min" },
  { id: 4, title: "Peptide Hormones and Growth Factors", type: "reading", duration: "20 min" },
  { id: 5, title: "Stimulants and Narcotics", type: "video", duration: "15 min" },
  { id: 6, title: "Diuretics and Masking Agents", type: "reading", duration: "15 min" },
  { id: 7, title: "Prohibited Methods in Sports", type: "video", duration: "20 min" },
  { id: 8, title: "Course Quiz", type: "quiz", duration: "15 min" },
]

export default function ProhibitedSubstancesCourse() {
  ...
  const navigateToCertificate = () => {
    navigate('/courses/prohibited-substances/certificate')
  }
                        ...
                        <div className="space-y-4">
                          <div className="aspect-w-16 aspect-h-9 h-[380px]">
                            <iframe
                              ...
                              src="https://www.youtube.com/embed/3I4K8ZH4s6s"
