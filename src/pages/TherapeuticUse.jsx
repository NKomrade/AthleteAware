...
const courseContent = [
    { id: 1, title: "Introduction to Therapeutic Use Exemptions", type: "video", duration: "12 min" },
    { id: 2, title: "When is a TUE Needed?", type: "reading", duration: "18 min" },
    { id: 3, title: "TUE Application Process", type: "video", duration: "14 min" },
    { id: 4, title: "Medical Conditions Requiring TUEs", type: "reading", duration: "20 min" },
    { id: 5, title: "TUE Management and Documentation", type: "video", duration: "16 min" },
    { id: 6, title: "How to Appeal a TUE Decision", type: "reading", duration: "15 min" },
    { id: 7, title: "Real-Life TUE Case Studies", type: "video", duration: "22 min" },
    { id: 8, title: "TUE Course Quiz", type: "quiz", duration: "15 min" },
  ];
  

export default function TherapeuticUseCourse() {
                      ...
                      {section.id === 1 ? (
                        <div className="space-y-4">
                          <div className="aspect-w-16 aspect-h-9 h-[380px]">
                            <iframe
                              src="https://www.youtube.com/embed/wYBlCciH_0o"
