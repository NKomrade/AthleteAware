...
const courseContent = [
  { id: 1, title: "What is Doping?", type: "video", duration: "10 min" },
  { id: 2, title: "History of Anti-Doping Efforts", type: "reading", duration: "15 min" },
  { id: 3, title: "Prohibited Substances and Methods", type: "video", duration: "20 min" },
  { id: 4, title: "Health Risks of Doping", type: "reading", duration: "15 min" },
  { id: 5, title: "Anti-Doping Rules and Regulations", type: "video", duration: "25 min" },
  { id: 6, title: "Course Quiz", type: "quiz", duration: "15 min" },
]
...
export default function CourseIntroductionPage() {
  ...
  const navigateToCertificate = () => {
    navigate(`/courses/introduction-to-anti-doping/certificate`)
  }
                        ...
                        <div className="space-y-4">
                          <div className="aspect-w-16 aspect-h-9 h-[380px]">
                            <iframe
                              ...
                              src="https://www.youtube.com/embed/qscWqUhYnx0"
