...
export default function CertificatePageTesting() {
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center items-center p-4">
      <animated.div style={fadeIn} className="bg-white p-8 rounded-lg shadow-lg max-w-2xl w-full text-center">
        ...
        <p className="text-xl mb-8 text-gray-700">
          You've successfully completed the Testing Procedures course.
        </p>
        ...
        <p className="text-lg mb-8 text-gray-700">
          ...
          completed the Testing Procedures course on {new Date().toLocaleDateString()}.
        </p>
